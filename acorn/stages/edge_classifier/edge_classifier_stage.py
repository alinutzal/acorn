...
class EdgeClassifierStage(LightningModule):
    ...
    def setup(self, stage="fit"):
        ...
        if stage in ["fit", "predict"]:
            ...
            torch.set_float32_matmul_precision("medium" if stage == "fit" else "highest")
        elif stage == "test":
    ...
    def train_dataloader(self):
        ...
        return DataLoader(self.trainset, batch_size=1, num_workers=num_workers, pin_memory=True, persistent_workers=True)
    ...
    def val_dataloader(self):
        ...
        return DataLoader(self.valset, batch_size=1, num_workers=num_workers, pin_memory=True, persistent_workers=True)
    ...
    def test_dataloader(self):
        ...
        return DataLoader(self.testset, batch_size=1, num_workers=num_workers, pin_memory=True, persistent_workers=True)
